...
#            self.logger.info(logcontent)
    ...
    def __secondblock_handle(self, data):
        ...
        # Receive a secondblock commition 
            ...
            logcontent = 'Receive a second commitment:' + str(data['messageid'])
            self.logger.info(logcontent)
        ...
        # Receive a commit secondblock
            ...
            logcontent = 'Receive a commit secondblock:' + str(data['content']['block'][4])
            self.logger.info(logcontent)
...
#                        self.logger.info(logcontent)
                ...
                if len(glovar.BLOCKCHAIN):
                    ...
                    glovar.FIRSTBLOCKCHAIN.append(data['content']['block'])
                    logcontent = 'Add a firstblock to the chain'
                    self.logger.info(logcontent)
